 ...
 * uncached request after a revalidation window). A centered Three.js loader
 * sits over a faint skeleton that hints at the page layout.
 */
  ...
  return (
    <div className="relative min-h-screen">
      ...
      <div className="pointer-events-none absolute inset-0 flex items-center justify-center">
        <Loader3D size="lg" label="Aggregating GitHub activity…" />
      </div>
    </div>
  );
}
