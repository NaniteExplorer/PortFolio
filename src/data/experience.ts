 ...
 *
 * Keep copy concise and outcome-focused. Refine metrics and tech tags as roles evolve.
 */
export const experiences: Experience[] = [
  {
    ...
    logo: "Boxes",
    description:
      "Building a CAD-based product platform that turns complex geometric and engineering workflows into performant, dependable software for design and manufacturing teams.",
    highlights: [
  ...
  },
  {
    ...
    highlights: [
      "Designed, built, and launched the chapter's first official website",
